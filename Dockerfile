...
RUN pip3 install --no-cache-dir --upgrade setuptools wheel jupyterhub jupyter networkx pandas numpy bqplot colour bitarray sympy cython tatsu psutil prince pydot python-igraph ipycytoscape
...
RUN cd /root && wget https://github.com/fpom/pyddd/raw/master/libDDD.tar.gz
